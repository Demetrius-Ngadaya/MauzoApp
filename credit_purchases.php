...
$purchases_status = 'credit'; 
  ...
  $sql="INSERT INTO purchases_report(medicine_name, category, old_quantity,received_quantity, receipt_number,batch_number, date_to_pay,received_date, expire_date, company, sell_type, actual_price, selling_price, profit_price, credit_amount,created_by, status) 
  VALUES ('$med_name', '$category', '$old_quantity', '$received_quantity', '$receipt_number','$batch_number','$date_to_pay','$received_date','$new_exp_date', '$company', '$sell_type', '$actual_price', '$selling_price', '$profit_price','$credit_amount', '$created_by', '$purchases_status')";
