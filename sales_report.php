                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <center>
                          <form action="sales_report.php?invoice_number=<?php echo $_GET['invoice_number']?>" method="POST" class="form-inline">
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              if(isset($_POST['submit'])){
                                ...
                                $select_sql = "SELECT * FROM sales WHERE (Date BETWEEN '$d1' AND '$d2') OR (paid_date BETWEEN '$d1' AND '$d2')";
                                if (!empty($created_by)) {
