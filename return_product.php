        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rudisha Dawa</li> -->
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>Return sold products </b></h3>
              </div>
              ...
              <div class="card-body">
                <div style="overflow-x:auto; overflow-y: auto;">
                  ...
                  if (isset($_POST['return_to_stock'])) {
                    ...
                    $select_sale_sql = "SELECT * FROM sales WHERE id = ?";
                    ...
                    $select_stock_sql = "SELECT act_remain_quantity, used_quantity FROM stock WHERE id = ?";
                    ...
                    $current_remain_quantity = $stock_row['act_remain_quantity'];
                    ...
                    $update_stock_sql = "UPDATE stock SET act_remain_quantity = ?, used_quantity = ? WHERE id = ?";
                    ...
                    mysqli_stmt_bind_param($stmt_update_stock, "iii", $new_remain_quantity, $new_used_quantity, $medicine_id);
                  ...
                  if (isset($_POST['save_to_broken'])) {
                    ...
                    try {
                        ...
                        $insert_broken_sql = "INSERT INTO broken_products (id, returned_invoice, returned_medicines, returned_quantity, returned_amount, profit_lost, sold_by, sold_date, returned_by, returned_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                        $stmt_insert_broken = mysqli_prepare($con, $insert_broken_sql);
                        mysqli_stmt_bind_param($stmt_insert_broken, "issiiissss", $id, $returned_invoice, $returned_medicines, $returned_quantity, $returned_amount, $profit_lost, $sold_by, $sold_date, $returned_by, $returned_date);
                        ...
                        $select_stock_sql = "SELECT act_remain_quantity, used_quantity, quantity FROM stock WHERE id = ?";
                        $stmt_select_stock = mysqli_prepare($con, $select_stock_sql);
                        mysqli_stmt_bind_param($stmt_select_stock, "i", $medicine_id);
                        mysqli_stmt_execute($stmt_select_stock);
                        $result_stock = mysqli_stmt_get_result($stmt_select_stock);
                        ...
                        $update_stock_sql = "UPDATE stock SET  used_quantity = ?, quantity = ? WHERE id = ?";
                        $stmt_update_stock = mysqli_prepare($con, $update_stock_sql);
                        ...
                        echo "<div class='alert alert-success'>Product marked as broken and stock updated successfully.</div>";
                ...
                $select_sql = "SELECT * FROM sales ORDER BY Date DESC LIMIT $offset, $records_per_page";
                $select_query = mysqli_query($con, $select_sql);
                
                // Count total records
                $count_sql = "SELECT COUNT(*) AS total_records FROM sales";
