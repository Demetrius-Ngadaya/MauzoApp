  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-6">	
            <b>Credit sales report by date to pay</b>						
          </div>
          <div class="col-sm-6">
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              if(isset($_POST['submit'])){
                                ...
                                $select_sql = "SELECT * FROM sales WHERE (date_to_pay BETWEEN '$d1' AND '$d2') AND (payment_method='credit') AND (hali_ya_malipo='not paid') ";
                                if (!empty($created_by)) {
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT * FROM sales WHERE date_to_pay = '$date' AND payment_method ='credit' AND hali_ya_malipo='not paid' ";
                                $select_query = mysqli_query($con, $select_sql);
