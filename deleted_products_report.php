...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Bidhaa zilizo futwa</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>Ripoti ya bidhaa zilizo futwa</b></h3>
              </div>
              <!-- /.card-header -->
              <section class="content">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <center>
                          <form action="deleted_products_report.php?invoice_number=<?php echo $_GET['invoice_number']?>" method="POST" class="form-inline">
      ...
      <div class="form-group">
        <label for="deleted_by" class="sr-only">Aliyefuta:</label>
        <input type="text" id="deleted_by" name="deleted_by" class="form-control" placeholder="Aliye futa" autocomplete="off">
      </div>
      <div class="form-group">
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              if(isset($_POST['submit'])){
                                $d1 = $_POST['d1'];
                                $d2 = $_POST['d2'];
                                $created_by = $_POST['deleted_by'];
                                $medicine_name = $_POST['medicine_name'];
                                $category = $_POST['category'];
                                

                                $select_sql = "SELECT * FROM deleted_products WHERE (deleted_date BETWEEN '$d1' AND '$d2') OR (deleted_date BETWEEN '$d1' AND '$d2')";
                                if (!empty($deleted_by)) {
                                  $select_sql .= " AND deleted_by LIKE '%$deleted_by%'";
                                }
                                ...
                                $select_sql .= " ORDER BY deleted_date DESC";
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT * FROM deleted_products WHERE deleted_date = '$deleted_date'";
                                $select_query = mysqli_query($con, $select_sql);
                              ...
                              <tbody>
                                <tr> 
                                  <td><?php echo $row['deleted_date']?>&nbsp;&nbsp;(<font size='2' color='#009688;'>Leo</font>)</td>
                                  <td><?php echo $row['medicine_name']?></td>
                                  <td><?php echo $row['category']?></td>
                                  <td><?php echo $row['act_remain_quantity']?></td>
                                  <td><?php echo $row['used_quantity']?></td>
