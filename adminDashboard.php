                 ...
                 <div class="row">
                   <!-- Sales Graph -->
                     <div class="col-md-6">
                         <div class="card">
                           <div class="card-header">
                            <h3 class="card-title">Grafu ikionesha jumla ya idadi ya bidhaa zilizouzwa</h3>
                            </div>
                         <div class="card-body">
...
<script>
    ...
    var totalSalesChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Idadi ya bidhaa zilizouzwa',
                data: totalSales,
                fill: true,
...
<script>
    ...
    var salesChart = new Chart(ctxSales, {
        type: 'pie',
        data: {
            labels: ['Januari', 'Februari', 'Macihi', 'Apri', 'Mei', 'Juni', 'Julai', 'Agosti', 'Septemba', 'Oktoba', 'Novemba', 'Disemba'],
            datasets: [{
                label: 'Total sells',
                data: totalAmount,
                backgroundColor: [
