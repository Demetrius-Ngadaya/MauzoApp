...
$select_sql = "SELECT * FROM stock WHERE expire_date <= '$current_date' AND act_remain_quantity!=0 ORDER BY expire_date ASC";
...
<tr>
    ...
    <td><?php echo $row['actual_price']*$row['act_remain_quantity']?> Tsh</td>
</tr>
<?php endwhile;?>
</tbody>
</table>
