...
if(!isset($_SESSION['user_session'])){
    ...
    $update_sql = "UPDATE stock SET used_quantity = (used_quantity - '$hid_qty') + '$upd_qty' , act_remain_quantity = (act_remain_quantity + '$hid_qty')-'$upd_qty'  where medicine_name = '$med_name' and category = '$med_cat' and expire_date = '$ex_date' ";
   ...
   $select_sql1= "SELECT act_remain_quantity from stock where medicine_name = '$med_name' and category = '$med_cat' and expire_date = '$ex_date' ";
