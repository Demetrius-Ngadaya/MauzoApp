...
//GET Medicine Name And Expire Date
    ...
    $("#qty, #discount").blur(function(){
        ...
        if(avai_qty == "" || in_qty > avai_qty_int || in_qty <= 0){
            ...
            alert("Haujachagua bidhaa au umeandika idadi unayotaka kuuza idayozidi idadi iliyipo !!");
        } else {
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <form method="POST" action="insert_invoice.php?invoice_number=<?php echo $_GET['invoice_number']?> " style="display: flex; flex-wrap: wrap; gap: 10px;">
        ...
        <div class="form-group">
            <input type="number" name="discount" id="discount" placeholder="Punguzo" class="form-control" style="width: 180px; height: 30px;" required>
        </div>
        <div class="form-group">
