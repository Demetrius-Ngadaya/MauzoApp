...
<strong>
  ...
  <form method="POST" action="save_invoice.php">
      ...
      <tr>
<h3>Jina la mteja:<?php echo $paid_amount?>. &nbsp; Tarehe:<?php echo $date?>.&nbsp;  Risiti:<?php echo $invoice_number?>.  </h3>    
      </tr>
		<thead>
			<tr>
  ...
  <a href="home.php?invoice_number=<?php echo $_GET['invoice_number']?>"><button class="btn btn-default"><i class="icon-arrow-left"></i>Rudi nyuma</button></a>
