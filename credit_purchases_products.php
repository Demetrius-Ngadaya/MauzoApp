...
<!DOCTYPE html>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><b>Credit products</b></h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
    ...
    $select_sql = "SELECT * FROM purchases_report WHERE status='credit'";
    ...
    if (mysqli_num_rows($select_query) > 0) {
        ...
        echo '<tr><td colspan="11">You dont have any credit purchased product </td></tr>';
    }
    ?>
<script>
    ...
    function confirmMarkAsPaid(saleId) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "You are about to mark this product as paid!",
            icon: 'warning',
