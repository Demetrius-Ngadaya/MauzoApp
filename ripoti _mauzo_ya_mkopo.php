  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-6">	
            <b>Credit sales report by purchase date</b>						
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <center>
                <div> 
                <a href="ripoti _mauzo_ya_mkopo.php?invoice_number=<?php echo $_GET['invoice_number']?>">By sold date </a> &nbsp;&nbsp;&nbsp;&nbsp;
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              if(isset($_POST['submit'])){
                                ...
                                $select_sql = "SELECT * FROM sales WHERE (Date BETWEEN '$d1' AND '$d2') AND (payment_method='credit') AND (hali_ya_malipo='not paid') ";
                                if (!empty($created_by)) {
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT * FROM sales WHERE Date = '$date' AND payment_method ='credit' AND (hali_ya_malipo='not paid') ";
                                $select_query = mysqli_query($con, $select_sql);
