...
//GET Medicine Name And Expire Date
    ...
    $("#qty, #discount").blur(function(){
        ...
        if(avai_qty == "" || in_qty > avai_qty_int || in_qty <= 0){
            ...
            alert("You have not select medicine or you have entered amount larger than available quantity!!");
        } else {
...
<ul class="navbar-nav ml-auto">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="form-group">
            <input type="number" name="avai_qty" id="avai_qty" readonly placeholder="Available qty" class="form-control" style="width: 140px; height: 30px;">
        </div>
        <div class="form-group">
        <input type="text" id="selling_price" name="selling_price" readonly placeholder="medicine price" class="form-control" style="width: 140px; height: 30px;">

        </div>
        <!-- Third div for 'Idadi unayotaka kuuza' -->
        <div class="form-group">
            <input type="number" name="qty" id="qty" placeholder="selling qty" autocomplete="off" class="form-control" style="width: 160px; height: 30px;" required>
        </div>
        
        
        <!-- Fourth div for 'Punguzo' -->
        <div class="form-group">
            <input type="number" name="discount" id="discount" placeholder="discount" class="form-control" style="width: 100px; height: 30px;" required>
        </div>
        ...
        <select  name="payment_method" required> 
          <option value="Credit">Aina ya Malipo</option>
        ...
        <div class="form-group">
            <input type="number" name="phone_number" id="phone_number" placeholder="phone number" autocomplete="off" class="form-control" style="width: 190px; height: 30px;" required>
        </div>
        <div class="form-group">
  ...
  <div class="container table-responsive" >
    <div class="row">
      ...
      <a id="popup" href="checkoutCashier.php?invoice_number=<?php echo $_GET['invoice_number']?>&medicine_name=<?php echo $medicine_name?>&category=<?php echo $category?>&ex_date=<?php echo $ex_date?>&quantity=<?php echo $quantity?>&total=<?php echo $grand_total?>&profit=<?php echo $grand_profit?>" style="width:300px;" class="btn btn-info btn-large">Andika jina la mteja</i></a>
