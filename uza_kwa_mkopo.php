      ...
      <div class="container-fluid">
       ...
       <form method="POST" action="insert_invoice_mkopo.php?invoice_number=<?php echo $_GET['invoice_number']?> " style="display: flex; flex-wrap: wrap; gap: 10px;">
        ...
        <div class="form-group">
            <input type="text" id="product" required autocomplete="off" placeholder="Jina la bidhaa" class="form-control" style="width: 300px; height: 30px;">
            <input type="hidden" name="product" id="product_hidden" required class="form-control" autocomplete="off" placeholder="Jina la bidhaa" style="width: 400px; height: 30px;">
        ...
        <div class="form-group">
        <input type="text" id="selling_price" name="selling_price" readonly placeholder="Bei ya bidhaa" class="form-control" style="width: 140px; height: 30px;">
        ...
        <div class="form-group">
            <input type="number" name="discount" id="Punguzo" placeholder="discount" class="form-control" style="width: 100px; height: 30px;" required>
        </div>
        ...
        <div class="form-group">
            <input type="number" name="phone_number" id="phone_number" placeholder="Simu ya mteja" autocomplete="off" class="form-control" style="width: 190px; height: 30px;" required>
        </div>
        <div class="form-group">
        ...
        <thead>
          ...
          <?php
           if($medicine_name && $category && $quantity !=null){
            ...
            <a id="popup" href="checkout.php?invoice_number=<?php echo $_GET['invoice_number']?>&medicine_name=<?php echo $medicine_name?>&category=<?php echo $category?>&ex_date=<?php echo $ex_date?>&quantity=<?php echo $quantity?>&total=<?php echo $grand_total?>&profit=<?php echo $grand_profit?>" style="width:400px;" class="btn btn-info btn-large">Customer name</i></a>
