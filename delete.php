...
$fetch_sql = "SELECT * FROM stock WHERE id = '$id'";
...
if ($fetch_query && mysqli_num_rows($fetch_query) > 0) {
    ...
    $insert_sql = "INSERT INTO deleted_products (
        ...
        selling_price, profit_price, created_by, deleted_by, deleted_date, status
    ) VALUES (
        ...
        '{$row['created_by']}', '$deleted_by', '$deleted_date', '{$row['status']}'
    )";
